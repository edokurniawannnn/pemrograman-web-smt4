			...
			<div class="row">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box text-bg-primary">
						...
						<a href="data-dosen.php" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
							More info
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box text-bg-success">
						...
						<a href="data-mahasiswa.php" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
							More info
							<i class="bi bi-link-45deg"></i>
						</a>
					</div>
