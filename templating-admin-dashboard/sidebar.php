			...
			<ul
				...
				<li class="nav-item ">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							<a href="form-mahasiswa.php" class="nav-link">
								<i class="nav-icon bi bi-file-person"></i>
								<p>Input Data Mahasiswa</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="form-dosen.php" class="nav-link">
								<i class="nav-icon bi bi-file-person"></i>
				...
				<li class="nav-item">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							<a href="data-mahasiswa.php" class="nav-link">
								<i class="nav-icon bi bi-person"></i>
								<p>Data Mahasiswa</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="data-dosen.php" class="nav-link">
								<i class="nav-icon bi bi-person"></i>
								<p>Data Dosen</p>
							</a>
						</li>
